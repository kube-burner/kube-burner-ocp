...
func NewBuildFarm(wh *workloads.WorkloadHelper) *cobra.Command {
	...
	cmd.Flags().IntVar(&numControllers, "num-controllers", 4, "Number of controller replicas")
	cmd.Flags().IntVar(&numThreads, "num-threads", 4, "Number of threads per controller")
