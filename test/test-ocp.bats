...
@test "olmv1 benchmark" {
  run_cmd ${KUBE_BURNER_OCP} olm --log-level debug --uuid=${UUID} --iterations 2 --churn-cycles 1 --churn-delay=5s --catalogImage registry.redhat.io/redhat/redhat-operator-index:v4.18
